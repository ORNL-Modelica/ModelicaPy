...
if __name__ == '__main__':
    ...
    nPeriods = 1
    time_horizon = stop_time - start_time
    ...
    # define time horizon (default 50% movement forward in horizon)
    # save state of values at next time horizon
    # save input values from new horizon and guesstimate
    # (improved guess values should be learned from past examples..
    # i.e., optimization should get cheaper on average as time progresses)
